...
%todo: introduzione di ghiloni sullo spazio metrico e la distanza? maybe?
...
\marginpar{\textcolor{TopGener}{\textbf{Topologia}}}
\begin{definition}
...
\marginpar{\textcolor{TopGener}{\textbf{Topologia euclidea}}}
...
\begin{enumerate}
	...
	\marginpar{\textcolor{TopGener}{\textbf{Topologia banale, \newline discreta, cofinita}}}
	\item La topologia più povera in assoluto è la \textit{topologia banale}: 
	\begin{center}
		$\tau = \left\{\varnothing, X\right\}$ 
	\end{center}
	Vediamo che non è metrizzabile se non nel caso in cui $X = \left\{x\right\}$, ovvero quando $X$ è un \textit{singoletto}. \\ Infatti sia $d$ una distanza su $X$ e sia $X = \left\{p,q\right\}$ allora per ogni $\rho > 0 \; . \; q \in B_\rho(p)$, quindi $d(p,q) = 0$. Ma poiché $d$ è una distanza ottengo che $p=q$, contraddicendo l'ipotesi $p \neq q$. \\ Nel caso del singoletto invece è elementare che sia metrizzabile.
